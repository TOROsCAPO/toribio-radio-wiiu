...
"$WUHBTOOL" build/wiiu-radio.rpx dist/toribio-radio.wuhb --name="Toribio Radio para Wii U" --short-name="Toribio Radio" --author="Toribio Tecnologic" --icon=apps/radio/assets/icon.png --tv-image=apps/radio/assets/radio_bg_tv.jpg --drc-image=apps/radio/assets/radio_bg_drc.jpg --content=apps/radio/content
